...
function Background() {
    return (
        <group>
            ...
            {/* Nebula Glows (Safe replacement for Cloud) */}
            <mesh position={[0, 0, -20]}>
                <sphereGeometry args={[15, 32, 32]} />
                <meshBasicMaterial color="#4c1d95" transparent opacity={0.3} depthWrite={false} />
            </mesh>
            <mesh position={[15, 10, -25]}>
                <sphereGeometry args={[12, 32, 32]} />
                <meshBasicMaterial color="#0c4a6e" transparent opacity={0.2} depthWrite={false} />
            </mesh>

            {/* Floating Sparkles */}
            <Sparkles count={500} scale={20} size={2} speed={0.4} opacity={0.5} color="#fff" />

            {/* Distant Planet 1 (Gas Giant) */}
            ...
            {/* Distant Planet 2 (Ringed) */}
            <Float speed={1.5} rotationIntensity={0.5} floatIntensity={0.5}>
                <group position={[10, -5, -20]} rotation={[0.5, 0, 0.3]}>
                    <mesh>
                    ...
                    <mesh rotation={[1.6, 0, 0]}>
                        ...
                        <meshStandardMaterial color="#fbbf24" opacity={0.6} transparent />
                    </mesh>
                </group>
            </Float>
...
function SceneContent({ setScore, setGameOver, setShowPopup, isPlaying }: any) {
    ...
    return (
        <>
            ...
            <pointLight position={[-10, -10, -5]} color="#4c1d95" intensity={1} />
